        ...
        },
        {
          ...
          methods = {
            ...
            },
            {
              ...
              description = "Returns parameters that control how the volume of the Source falls off with distance.",
